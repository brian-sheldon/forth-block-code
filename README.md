...
Note: These images are actually cropped versions of the image for display here.  The original screenshots include the entire page, so the decoder must be able to find the image within the page.
...
Copyright © Brian Sheldon, [MIT license](/LICENSE)
